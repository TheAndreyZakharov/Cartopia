...
<div align="left">
  <div style="float: right; display: flex; flex-direction: column; gap: 12px;">
    <a href="https://www.openstreetmap.org" target="_blank">
      <img src="images/logos/OpenStreetMap_logo.png" alt="OpenStreetMap" width="250">
    </a>
    <a href="https://opentopography.org" target="_blank">
      <img src="images/logos/OpenTopography_logo.png" alt="OpenTopography" width="250">
    </a>
    <a href="https://www.gmrt.org" target="_blank">
      <img src="images/logos/GMRT_logo.png" alt="GMRT" width="250">
    </a>
  </div>
...
## 🖼 Демонстрация (реализовано на сегодня)
...
### Поклонная гора, проспект Энгельса, Санкт-Петербург
...
- Мосты, эстакады, развязки
- Вода, песок/пляжи, снег/лед, джунгли и тд скорректировать
--
- обработка зданий с невалидными полигонами
- внешний вид зданий приблизить к реальному

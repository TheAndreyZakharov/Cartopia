...
// все входы в здания - магазинчики и тд. с дверьми закрытими и над ними вешать табличку с названием того от чего этот вход (если магазин или организация - название, если дом - адрес, номер подъезда + таблички на дом вешать с названием улицы и номером дома с каждой стороны дома по табличке)
// Арки - Припять
// Градирни и тп не застраивать внутри и крышу не делать - просто стены без окон


// небольшие постройки без тега зданий отдельно - туалеты, бункеры, Дрессинг-ченджинг рум и тд
// антенны и вышки без тега зданий отдельно - chimney, mast и тд

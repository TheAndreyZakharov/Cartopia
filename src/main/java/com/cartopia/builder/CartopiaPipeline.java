...
// камеры скорости: highway=speed_camera, видеонаблюдение: man_made=surveillance (+ surveillance:type=camera)
// уличные шкафы/кабинки связи: man_made=street_cabinet, telecom=exchange
// таксофоны: amenity=telephone
...
// Солнечные батареи
// успокоители трафика: traffic_calming=table|hump|bump|cushion|chicane|island (ways)

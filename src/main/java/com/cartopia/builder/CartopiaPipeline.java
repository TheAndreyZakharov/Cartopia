...
// Десткие площадки. разноцветный терракот ставить на рандом + в центре пирамиду из рандомного цветного бетона (или из террактора этого) и сверху колокол и 4 скамейки с каждой стороны обращенных к центру

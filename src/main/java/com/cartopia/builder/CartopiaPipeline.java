...
public class CartopiaPipeline {
    ...
    public static void run(ServerLevel level, File coordsJsonFile, File demTifFile, File landcoverTifFileOrNull) throws Exception {
        ...
        try {
            ...
            // Градирни, трубы и тп не застраивать внутри и крышу не делать - просто стены без окон. дефолт высота 50 как и у труб если не указана высота
...
// удалять все предметы выпавшие несобранные - сделать что-то типа клинера
